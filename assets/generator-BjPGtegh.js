import{J as $}from"./jszip.min-Ew1mFSm8.js";import{c as w,b as d,n as R,d as P}from"./types-dbiTllwl.js";import"./index-CGldg-6M.js";function g(t){const r=[],n=/(\*\*(.+?)\*\*|\*(.+?)\*|([^*]+))/g;let e;for(;(e=n.exec(t))!==null;)e[2]!==void 0?r.push({text:e[2],style:{bold:!0}}):e[3]!==void 0?r.push({text:e[3],style:{italic:!0}}):e[4]!==void 0&&e[4]&&r.push({text:e[4],style:{}});return r.length===0&&t&&r.push({text:t,style:{}}),r}function x(t){const r={version:"1.0",metadata:{},content:[]},n=t.split(`
