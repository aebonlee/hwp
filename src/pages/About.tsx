...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | HWP Edit" description="한글(HWP/HWPX) 문서를 웹에서 편집·변환·생성·관리하는 통합 도구" />
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 한글(HWP/HWPX) 문서를 웹에서 편집·변환·관리하는 통합 도구입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              별도 프로그램 설치 없이 웹 브라우저에서 한글 문서를 열람, 편집, 변환할 수 있습니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-file-word', title: '문서 편집', desc: 'HWP/HWPX 문서를 웹에서 직접 편집할 수 있습니다.' },
              { icon: 'fa-arrows-rotate', title: '포맷 변환', desc: 'HWP ↔ PDF, DOCX 등 다양한 포맷으로 변환합니다.' },
              { icon: 'fa-cloud', title: '웹 기반', desc: '설치 없이 브라우저에서 바로 사용할 수 있습니다.' },
              { icon: 'fa-shield-halved', title: '안전 관리', desc: '문서를 안전하게 관리하고 공유할 수 있습니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
