    ...
    site: {
      ...
      pricing: {
        ...
        compare: {
          ...
          humanize: { label: 'AI 휴머나이징', free: '사용자 키', basic: '20회/월', pro: '무제한' },
          maxLength: { label: '최대 문서 길이', free: '5,000자', basic: '30,000자', pro: '50,000자' },
        ...
        faq2: { q: 'AI 휴머나이징은 어떤 기능인가요?', a: 'AI가 생성한 문서를 사람이 작성한 것처럼 자연스럽게 변환합니다. 변환 강도와 어체를 선택할 수 있으며, 원본과 결과를 문단별로 비교할 수 있습니다.' },
    ...
    site: {
      ...
      pricing: {
        ...
        compare: {
          ...
          humanize: { label: 'AI Humanize', free: 'Own key', basic: '20/mo', pro: 'Unlimited' },
          maxLength: { label: 'Max Length', free: '5,000 chars', basic: '30,000 chars', pro: '50,000 chars' },
        ...
        faq2: { q: 'What is AI Humanization?', a: 'It transforms AI-generated documents into natural, human-written text. You can choose intensity and tone, and compare the original with the result paragraph by paragraph.' },
