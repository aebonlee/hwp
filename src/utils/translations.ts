  ...
  ko: {
    ...
    site: {
      ...
      pricing: {
        ...
        proBtn: 'Pro 시작',
        compare: {
          price: { label: '월 요금', free: '무료', basic: '₩9,900', pro: '₩29,900' },
          converts: { label: '변환 횟수', free: '5회/월', basic: '50회/월', pro: '무제한' },
          humanize: { label: 'AI 처리량', free: '사용자 키', basic: '월 150,000자', pro: '월 500,000자' },
          maxLength: { label: '1회 최대 길이', free: '5,000자', basic: '30,000자', pro: '50,000자' },
          export: { label: '내보내기', free: 'Markdown', basic: 'Markdown, HWPX', pro: 'Markdown, HWPX, PDF' },
          storage: { label: '문서 저장', free: '1개', basic: '30개', pro: '무제한' },
          support: { label: '지원', free: '-', basic: '이메일', pro: '이메일 + 카카오톡' },
        },
        faq1: { q: '무료 요금제로도 변환이 가능한가요?', a: '네, 무료 요금제에서도 월 5회까지 HWP/HWPX → Markdown 변환을 이용할 수 있습니다. 마크다운 에디터도 제한 없이 사용 가능합니다.' },
        faq2: { q: 'AI 처리량은 어떻게 계산되나요?', a: 'AI 휴머나이징, AI 문서 작성, 사업계획서 생성 등 모든 AI 기능 사용 시 처리된 글자 수가 차감됩니다. 월 할당량을 초과하면 다음 달까지 대기하거나 사용자 API 키로 계속 이용할 수 있습니다.' },
        faq3: { q: '요금제는 언제든 변경할 수 있나요?', a: '네, 언제든 업그레이드 또는 다운그레이드가 가능합니다. 업그레이드 시 즉시 적용되며, 다운그레이드는 다음 결제일부터 적용됩니다.' },
        faq4: { q: '사용자 API 키는 어떻게 사용하나요?', a: '무료 요금제에서 AI 기능을 사용하려면 본인의 Claude 또는 OpenAI API 키를 입력하면 됩니다. API 키는 브라우저에만 저장되며 서버로 전송되지 않습니다.' },
        faq5: { q: '환불 정책은 어떻게 되나요?', a: '결제 후 7일 이내 사용 이력이 없는 경우 전액 환불이 가능합니다. 자세한 사항은 고객센터로 문의해 주세요.' },
      },
      home: {
        title: 'HWP Web',
  ...
  en: {
    ...
    site: {
      ...
      pricing: {
        ...
        proBtn: 'Start Pro',
        compare: {
          price: { label: 'Monthly', free: 'Free', basic: '₩9,900', pro: '₩29,900' },
          converts: { label: 'Conversions', free: '5/mo', basic: '50/mo', pro: 'Unlimited' },
          humanize: { label: 'AI Quota', free: 'Own key', basic: '150,000 chars/mo', pro: '500,000 chars/mo' },
          maxLength: { label: 'Max per Request', free: '5,000 chars', basic: '30,000 chars', pro: '50,000 chars' },
          export: { label: 'Export', free: 'Markdown', basic: 'Markdown, HWPX', pro: 'Markdown, HWPX, PDF' },
          storage: { label: 'Storage', free: '1 doc', basic: '30 docs', pro: 'Unlimited' },
          support: { label: 'Support', free: '-', basic: 'Email', pro: 'Email + Kakao' },
        },
        faq1: { q: 'Can I convert files with the free plan?', a: 'Yes, the free plan allows up to 5 HWP/HWPX → Markdown conversions per month. The Markdown editor is also available without limits.' },
        faq2: { q: 'How is the AI quota calculated?', a: 'All AI features (humanization, AI writer, business plan generation) consume characters from your monthly quota. When exceeded, you can wait for the next month or use your own API key to continue.' },
        faq3: { q: 'Can I change my plan anytime?', a: 'Yes, you can upgrade or downgrade at any time. Upgrades take effect immediately, and downgrades apply from the next billing date.' },
        faq4: { q: 'How do I use my own API key?', a: 'To use AI features on the free plan, enter your Claude or OpenAI API key. Keys are stored only in your browser and never sent to our servers.' },
        faq5: { q: 'What is the refund policy?', a: 'Full refunds are available within 7 days of payment if no usage has occurred. Please contact support for details.' },
      },
      home: {
        title: 'HWP Web',
