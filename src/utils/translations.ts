    ...
    site: {
      ...
      pricing: {
        ...
        compare: {
          ...
          export: { label: '내보내기', free: 'Markdown', basic: 'Markdown, HWPX', pro: 'Markdown, HWPX' },
          storage: { label: '문서 저장', free: '1개', basic: '30개', pro: '무제한' },
          support: { label: '지원', free: '-', basic: '이메일', pro: '이메일' },
        },
    ...
    site: {
      ...
      pricing: {
        ...
        compare: {
          ...
          export: { label: 'Export', free: 'Markdown', basic: 'Markdown, HWPX', pro: 'Markdown, HWPX' },
          storage: { label: 'Storage', free: '1 doc', basic: '30 docs', pro: 'Unlimited' },
          support: { label: 'Support', free: '-', basic: 'Email', pro: 'Email' },
        },
